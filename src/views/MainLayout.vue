      ...
      <div v-else class="map" id="map">
        ...
        <!-- 区划图 -->
          ...
          <el-amap-polygon
            :visible="true"
            :path="riverway.path" 
            v-model:fillColor="riverway.fillColor"
            v-model:strokeColor="riverway.strokeColor"
            :strokeStyle="riverway.strokeStyle"
          />
          <el-amap-marker
            :visible="true"
            :position="riverway.markerPath"
            :label="{ content: '锦江', offset: [5, 5] }"
          />
          <el-amap-polyline
            :visible="true"
            :path="riverway.linePath"
            :strokeColor="'#FF0000'"
            :strokeWeight="7"
            :lineCap="'round'"
            :lineJoin="'round'"
          ...
          <el-amap-polygon
            ...
            :path="school.path"
            v-model:fillColor="school.fillColor"
            v-model:strokeColor="school.strokeColor"
            :strokeStyle="school.strokeStyle"
          />
          <el-amap-marker
            :visible="buildingVisible"
            :position="school.markerPath"
            :label="{ content: '西南交通大学', offset: [5, 5] }"
          />
          <el-amap-polygon
            :visible="buildingVisible"
            :path="shaheyuan.path"
            v-model:fillColor="shaheyuan.fillColor"
            v-model:strokeColor="shaheyuan.strokeColor"
            :strokeStyle="shaheyuan.strokeStyle"
          />
          <el-amap-marker
            :visible="buildingVisible"
            :position="shaheyuan.markerPath"
            :label="{ content: '沙河源公园', offset: [5, 5] }"
          />
          <el-amap-polygon
            :visible="buildingVisible"
            :path="youthPalace.path"
            v-model:fillColor="youthPalace.fillColor"
            v-model:strokeColor="youthPalace.strokeColor"
            :strokeStyle="youthPalace.strokeStyle"
          />
          <el-amap-marker
            :visible="buildingVisible"
            :position="youthPalace.markerPath"
            :label="{ content: '青年宫', offset: [5, 5] }"
          />
          <el-amap-polygon
            :visible="buildingVisible"
            :path="bridge.path"
            v-model:fillColor="bridge.fillColor"
            v-model:strokeColor="bridge.strokeColor"
            :strokeStyle="bridge.strokeStyle"
          />
          <el-amap-marker
            :visible="buildingVisible"
            :position="[104.059302, 30.694858]"
            :label="{ content: '府河桥', offset: [5, 5] }"
          />
          <el-amap-polyline
            :editable="false"
            :visible="!buildingVisible"
          ...
          />
            <el-amap-marker
            :visible="!buildingVisible"
            :position="[104.058918,30.702823]"
            :label="{ content: '第五排水口；<br>经度:104.058918<br>纬度:30.702823', offset: [10, 10] }"
          />
        </el-amap>
      </div>
    </el-main>
...
const integralVisible = ref(true);
